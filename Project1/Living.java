...
public abstract class Living 
{
	...
	{		
		...
		int startRow = (this.row > 0) ? this.row - 1 : this.row;
		int endRow = (this.row < plain.getWidth() - 1) ? this.row + 1 : this.row;
		int startCol = (this.column > 0) ? this.column - 1 : this.column;
		int endCol = (this.column < plain.getWidth() - 1) ? this.column + 1 : this.column;
